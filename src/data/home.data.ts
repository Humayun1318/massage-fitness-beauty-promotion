import type {
    Service, Treatment, Testimonial, FAQItem, Stat, ProcessStep, WhyCard, Benefit,
} from '@/types';
...
export const SERVICES: Service[] = [
    {
        ...
        title: 'Massage',
        description:
            'Focuses on fixing underlying issues, whether they are related to muscle injuries',
...
export const WHY_CARDS: WhyCard[] = [
    ...
    {
        title: 'Fully Insured',
        description: 'Complete public liability and professional indemnity insurance for your peace of mind.',
    },
    {
        title: 'Mobile Services',
        description: 'We come to you — home, hotel, office, or holiday property. No travel on your part.',
    },
    {
        title: 'Flexible Booking',
        description: 'Early mornings, evenings, and weekends available. Book online in under two minutes.',
    },
    {
        title: 'Pro Equipment',
        description: 'All professional-grade equipment and premium product ranges brought to every appointment.',
    },
    {
...
export const PROCESS: ProcessStep[] = [
    {
        step: 1,
        title: 'Book Online',
        description: 'Choose your service, pick a time that works for you, and confirm your booking in minutes.',
    },
    {
        step: 2,
        title: 'Consultation',
        description: 'A short pre-session consultation ensures every treatment is perfectly tailored to your needs.',
    },
    {
        step: 3,
...
export const BENEFITS: Benefit[] = [
    ...
    { title: 'Radiant Beauty', description: 'Premium treatments for glowing, healthy skin and nails.' },
    { title: 'Fitness Results', description: 'Structured programmes that deliver measurable progress.' },
